...
Uuid BLE_SERVICE_RFID_UUID = Uuid.parse("00000D00-5226-4AE0-8977-656FD3C42DA2");
            
Uuid BLE_CHARACTERISTIC_RFID_READ = Uuid.parse("00000D01-5226-4AE0-8977-656FD3C42DA2");
            
Uuid BLE_SERVICE_RADAR_UUID = Uuid.parse("00000C00-5226-4AE0-8977-656FD3C42DA2");
            
Uuid BLE_CHARACTERISTIC_RADAR_UUID = Uuid.parse("00000C01-5226-4AE0-8977-656FD3C42DA2");
...
List<Uuid> deviceServices = [BLE_SERVICE_PROXIMITY_UUID,BLE_SERVICE_THERMOMETER_UUID,BLE_SERVICE_RFID_UUID,BLE_SERVICE_RADAR_UUID,BLE_SERVICE_OTA_UUID,BLE_SERVICE_BATTERY,];
