...
//Genrate in git submodule (ble_devices) -> ble_uuid+generator.py
...
List<Uuid> deviceServices = [BLE_SERVICE_PROXIMITY_UUID,BLE_SERVICE_THERMOMETER_UUID,BLE_SERVICE_OTA_UUID,];
